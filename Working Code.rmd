...
```
Interesting. Wierdly some different shifting proteins (and a lot less) were identified I think (need for further anaylsis or comparison with known RBPs). For example 5NT3A_HUMAN	is identified as a shifter here, but not in the first two methods. RDeep says it is a shifter though. not that bad so maybe?
