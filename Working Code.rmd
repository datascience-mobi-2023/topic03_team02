...
sum(shift_dataframe$Shift == "left shift") + sum(shift_dataframe$Shift == "right shift")
```
Nice! Both methods seem to give the EXACT SAME PROTEINS! (Only comparing the number would not guarantee that the proteins are identical, but this is proven now.)
