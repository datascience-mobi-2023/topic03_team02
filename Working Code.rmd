...
# Add the protein names to the new dataframe
max_values$Protein <- p_values_Ctrl$Protein

# Print the new dataframe
print(max_values)
```
This still leaves us with the problems on how to handel NA values, as soon as several zeros appear in the experiment, the student t-test causes issues. Either we try to fix this or we try another method...
