...
Verkürzter y-shift code (anderer noch nicht fertig, würde ich davor kopieren, aber damit working code erstmal wieder läuft würde ich warten bis der fertig ist.)
```{r}
...
```{r}
#here we don´t need to generate a new dataframe since we already have one we can work with
show(df_results_yshift) #dieser dataframe existert gerade noch nicht in diesem dokument!!!
