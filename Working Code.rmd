...
identical_fractions["RBM3_HUMAN",]
```
...
#fviz_nbclust(quotients_minmax, kmeans, method='wss')        #optimal number of cluster = 2
#fviz_nbclust(quotients_minmax, kmeans, method='gap_stat')   #optimal number of cluster = 6 ?!
...
```
Das sieht auf jeden Fall schonmal anders aus. Aber besser?! -> villeicht
