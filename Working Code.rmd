...
Rows with just one peak
still does not want to cooperate :l
```{r}
...
Nooww, a similar code, but plots the graph using the name of the protein and not just its index in the dataframe
-> Does basically the same as the previous code, but its cool to plot just using the protein name hehe
```{r}
# Select a specific row by name
row_name <- "1433B_HUMAN"
