...
Next step would be now to compare all the location of the absolute and local maxima in Control and RNase with each other, and then only count the proteins in which the multiple peaks are not all in the same fractions, as this would hint at measurement inaccuracies.  
