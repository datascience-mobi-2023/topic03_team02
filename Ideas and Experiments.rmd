...
```{r}
plot(1:25, Mitosis_Ctrl_mean[which(rownames(RDeeP_HeLa_Mitosis)==c("1433B_HUMAN")),],type="l",lwd=3,col="blue",xlab="Fractions",ylab="Relative Protein Amount",main="1433B_HUMAN")
...
```
```{r}
plot(1:25, Mitosis_Ctrl_mean[which(rownames(RDeeP_HeLa_Mitosis)==c("2A5A_HUMAN")),],type="l",lwd=3,col="blue",xlab="Fractions",ylab="Relative Protein Amount",main="2A5A_HUMAN")
...
Also added ylim
```{r}
plot(1:25, Mitosis_Ctrl_100[which(rownames(RDeeP_HeLa_Mitosis)==c("1433B_HUMAN")),],type="l",lwd=3,col="blue",xlab="Fractions",ylab="Relative Protein Amount",main="1433B_HUMAN Normalized", ylim=c(0,100))
...
```{r}
plot(1:25, Mitosis_Ctrl_100[which(rownames(RDeeP_HeLa_Mitosis)==c("2A5A_HUMAN")),],type="l",lwd=3,col="blue",xlab="Fractions",ylab="Relative Protein Amount",main="2A5A_HUMAN Normailzed", ylim=c(0,100))
