...
shift_dataframe #right shift, left shift, no shift
#local maxima amount and location comparison
identical_fractions #TRUE: no shifter, FALSE: Shifter
#
```


```{r}
#Versuch einen kmeans mit Max shift und Protein ding zu machen?
