...
parameters.scaled <- apply(parameters, 2, function(x) {
...
weight <- c(1, 2) #Hier quotients doppelt so viel wie maximum_fraction gewichtet
...
fviz_cluster(km.maxquo, data = maximum_fraction)
```
