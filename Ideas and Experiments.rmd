...
#### 3.4 LOCAL MAX CODE DER ANZAHL DES LOCAL SHIFTS IDENTIFIZIERT
...
#-> usable? GGF hier einfach NUR DEN WERT NEHMEN, DER AM MEISTEN ABWEICHT!
...
comparison_RBP <- read.csv("https://www.dropbox.com/s/xpjob8g8flxl3ik/Table_HS_RBP.txt?dl=1", header = TRUE, sep = "", row.names = 1)

comparison_RBP1 <- read.delim("~/GitHub/topic03_team02/Datensatz_RBP2GO_Proteins.txt", row.names=1, comment.char="#")

# View the loaded data
head(comparison_RBP1)
```
