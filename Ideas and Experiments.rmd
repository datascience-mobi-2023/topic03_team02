...
```{r}
plot(1:25, Mitosis_Ctrl_mean[which(rownames(RDeeP_HeLa_Mitosis)==c("1433B_HUMAN")),],type="l",lwd=3,col="green",xlab="Fractions",ylab="Relative Protein Amount",main="1433B_HUMAN")
lines(1:25, Mitosis_RNase_mean[which(rownames(RDeeP_HeLa_Mitosis)==c("1433B_HUMAN")),], type="l",lwd=3,col="red")
grid()
legend("topright",legend=c("Control","RNase"),col=c("green","red"),bg="white",lwd=2)
```
```{r}
plot(1:25, Mitosis_Ctrl_mean[which(rownames(RDeeP_HeLa_Mitosis)==c("2A5A_HUMAN")),],type="l",lwd=3,col="green",xlab="Fractions",ylab="Relative Protein Amount",main="2A5A_HUMAN")
lines(1:25, Mitosis_RNase_mean[which(rownames(RDeeP_HeLa_Mitosis)==c("2A5A_HUMAN")),], type="l",lwd=3,col="red")
grid()
legend("topright",legend=c("Control","RNase"),col=c("green","red"),bg="white",lwd=2)
```
...
```{r}
plot(1:25, Mitosis_Ctrl_100[which(rownames(RDeeP_HeLa_Mitosis)==c("1433B_HUMAN")),],type="l",lwd=3,col="green",xlab="Fractions",ylab="Relative Protein Amount",main="1433B_HUMAN Normalized", ylim=c(0,25))
lines(1:25, Mitosis_RNase_100[which(rownames(RDeeP_HeLa_Mitosis)==c("1433B_HUMAN")),], type="l",lwd=3,col="red")
grid()
legend("topright",legend=c("Control","RNase"),col=c("green","red"),bg="white",lwd=2)
```

```{r}
plot(1:25, Mitosis_Ctrl_100[which(rownames(RDeeP_HeLa_Mitosis)==c("2A5A_HUMAN")),],type="l",lwd=3,col="green",xlab="Fractions",ylab="Relative Protein Amount",main="2A5A_HUMAN Normailzed", ylim=c(0,18))
lines(1:25, Mitosis_RNase_100[which(rownames(RDeeP_HeLa_Mitosis)==c("2A5A_HUMAN")),], type="l",lwd=3,col="red")
grid()
legend("topright",legend=c("Control","RNase"),col=c("green","red"),bg="white",lwd=2)
```
