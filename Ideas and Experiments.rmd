...
calculate_maxima_diff <- function(row_name, Mitosis_Ctrl_100, Mitosis_RNase_100) {
  ...
  # Calculate RBP threshold (20% deviation from Ctrl Max)
  lower_bound <- row_global_max_Ctrl * 0.5
  upper_bound <- row_global_max_Ctrl * 1.5
...
# Apply the function to each row name
results <- sapply(row_names, calculate_maxima_diff, Mitosis_Ctrl_100 = Mitosis_Ctrl_mean, Mitosis_RNase_100 = Mitosis_RNase_mean)

# Create a dataframe with the results
results_df <- data.frame(ProteinType = results)

# Print the final dataframe
print(results_df)
sum(results_df$ProteinType == 'RBP')
```
...
## Speicherung Code zur Erstellung des result dataframes, aus Working code rüberkopiert:
